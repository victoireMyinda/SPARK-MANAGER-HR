...
class CardPresenceToday extends StatefulWidget {
  final Map? data;
  const CardPresenceToday({super.key, this.data});

  @override
  State<CardPresenceToday> createState() => _CardPresenceTodayState();
}

class _CardPresenceTodayState extends State<CardPresenceToday> {
  @override
