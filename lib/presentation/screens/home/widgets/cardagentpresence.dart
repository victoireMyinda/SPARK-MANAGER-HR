...
class CardAgentPresence extends StatefulWidget {
  final Map? data;
  const CardAgentPresence({super.key, this.data});

  @override
  State<CardAgentPresence> createState() => _CardAgentPresenceState();
}

class _CardAgentPresenceState extends State<CardAgentPresence> {
  @override
