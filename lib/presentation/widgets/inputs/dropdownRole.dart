...
class TransAcademiaDropDownRole extends StatefulWidget {
  ...
  _TransAcademiaDropDownRoleState createState() =>
      _TransAcademiaDropDownRoleState();
}

class _TransAcademiaDropDownRoleState extends State<TransAcademiaDropDownRole> {
                  ...
                  onChanged: (newValue) {
                    ...
                    if (widget.value == "role") {
                      BlocProvider.of<SignupCubit>(context).updateField(context,
                          field: "role", data: newValue.toString());
                    }
                  },
                  items: dropdownItems
